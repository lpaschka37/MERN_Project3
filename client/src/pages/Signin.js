          ...
          {(!signedInUser) ? (
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3">
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="card shadow-sm mb-4">
                  <div className="card-body custom-card-dark">
                    <h4 className="card-title">Currently signed in as {signedInUser}</h4>
                    <button onClick={handleSignOut} type="submit" className="home-btn form-btn card-title">Sign Out</button>
                  </div>
                </div>
              </div>
            </div>
