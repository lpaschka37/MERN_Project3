    ...
    >
      ...
      >
        <Nav className="top-nav">
          ...
          <Nav.Link href="#cart" className="primary-col">
            <i className="fas fa-user"></i> Login
          </Nav.Link>
=======
    <Navbar collapseOnSelect expand="lg" className="navbar navbar-dark bg-dark container-fluid">
      <Navbar.Brand href="/" className="navbar-brand primary-col"><i className="fas fa-store-alt"></i>Garyphenalia</Navbar.Brand>
      <Navbar.Toggle aria-controls="responsive-navbar-nav" />
      <Navbar.Collapse id="responsive-navbar-nav" className="justify-content-end">
        <Nav className="top-nav">
          ...
          <Nav.Link href="/checkout" className="primary-col"><i className="fas fa-shopping-cart"></i>  Cart</Nav.Link>
          <Nav.Link href="/signin" className="primary-col"><i className="fas fa-user"></i>  Login</Nav.Link>
>>>>>>> main
        </Nav>
      </Navbar.Collapse>
    </Navbar>
